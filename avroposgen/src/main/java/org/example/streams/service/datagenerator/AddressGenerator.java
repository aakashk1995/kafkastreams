...
class AddressGenerator {
    ...
    public AddressGenerator() {
        ...
        try {
           ...
           // addresses = mapper.readValue(new File(String.valueOf(new InputStreamReader(getClass().getResourceAsStream("src/main/resources/data/address.json")))), DeliveryAddress[].class);
        } catch (Exception e) {
